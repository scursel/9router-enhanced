...
import { Card, Button, Badge, Input, Modal, CardSkeleton, OAuthModal, KiroOAuthWrapper, CursorAuthModal, ZedAuthModal, XiaomiMimoAuthModal, IFlowCookieModal, GitLabAuthModal, Toggle, Select, EditConnectionModal, NoAuthProxyCard, ConfirmModal, ErrorReason } from "@/shared/components";
...
export default function ProviderDetailPage() {
  ...
  const { getCircuitBreakerForConnection, resetCircuitBreaker } = useCircuitBreakers();
          ...
          <div key={conn.id} className="flex min-w-0 items-stretch">
            ...
            <div className="flex-1 min-w-0">
              <ConnectionRow
                ...
                circuitBreaker={getCircuitBreakerForConnection(providerId, conn.id)}
                onResetCircuit={() => resetCircuitBreaker(`${providerId}:${conn.id}`)}
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6 px-1 sm:gap-8 sm:px-0">
      ...
      <Card>
        ...
        {!!modelsTestError && (
          <div className="mb-3">
            <ErrorReason error={modelsTestError} />
