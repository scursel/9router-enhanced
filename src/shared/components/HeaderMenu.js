    ...
    <>
      <div className="relative" ref={menuRef}>
        <button
          ...
          className="flex items-center justify-center p-1.5 sm:p-2 rounded-lg text-text-muted hover:text-text-main hover:bg-black/5 dark:hover:bg-white/5 transition-all"
          title="Menu"
        >
