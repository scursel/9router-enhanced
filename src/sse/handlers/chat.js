...
async function handleSingleModelChat(body, modelStr, clientRawRequest = null, request = null, apiKey = null, attemptUsage = null) {
  ...
  while (true) {
    ...
    if (!credentials || credentials.allRateLimited) {
      ...
      // (fork); the last upstream's rate-limit headers still ride along (v0.5.91).
      return errorResponse(HTTP_STATUS.SERVICE_UNAVAILABLE, lastError || "All accounts unavailable", lastHeaders);
    }
